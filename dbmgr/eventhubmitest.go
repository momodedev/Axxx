...
// and [EventDataBatch].
func sendEvents() *eventExample {

	eventHubNamespace := "s32blobdatamigration-ehns.servicebus.windows.net" //os.Getenv("EVENTHUB_NAMESPACE") // <ex: myeventhubnamespace.servicebus.windows.net>
	eventHubName := "fulljob"                                               //os.Getenv("EVENTHUB_NAME")
	...
	return &eventExample{client: producerClient}
}
